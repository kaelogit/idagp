...
export const recipientStories: RecipientStory[] = [
  ...
  },
  {
    ...
    story: [
      ...
      'The $640,000 grant let me open Hale Field Supply. I still work long days. The difference is the name on the door is mine, and the people I hired are on a payroll I can actually meet. IDA did not make me a salesman. I already was one. They gave me the start so I could work for myself.',
    ],
  },
  {
    name: 'Marisol V.',
    ...
    story: [
      ...
      'The $950,000 grant covered what the lender would not. We closed in April. The first night I sat on the floor of an empty living room and laughed until I cried. The house is modest. It is ours. Buying a home should not require a miracle. For us, an IDA grant was the last honest piece.',
    ],
  },
  {
    name: 'Keisha Grant',
    ...
    story: [
      ...
      'One hundred twenty-five thousand dollars restocked my room and caught up two months I had fallen behind. I still buy stickers. I do not skip my own grocery run to do it.',
    ],
  },
  {
    name: 'Arthur N.',
    ...
    story: [
      ...
      'The $310,000 grant paid the therapy and the remaining hospital share. I walk the river path again. Slowly. But I walk.',
    ],
  },
  {
    name: 'Priya S.',
    ...
    story: [
      ...
      'The $385,000 grant covered the remaining year. I finished. I work days now. When a patient asks how I got here, I tell them someone believed school was worth a grant, not another loan.',
    ],
  },
  {
    name: 'Calvin Reed',
    ...
    story: [
      ...
      'Seven hundred twenty thousand dollars in grant money closed the file with the hospital. I still have follow-up appointments. I do not have a collector’s number saved in my phone.',
    ],
  },
  {
    name: 'Elena Briggs',
    ...
    story: [
      ...
      'The $210,000 grant put the utilities and the overdue dental work behind me. My son still visits. He brings pie, not cash. That is how it should be.',
    ],
  },
  {
    name: 'Jonah M.',
    ...
    story: [
      ...
      'The $520,000 grant closed the hospital file. I still have physical therapy. I do not have a collector saved as “Unknown.” If you are sitting with medical bills, you are not the first person IDA has heard from today.',
    ],
  },
  {
    name: 'Nadia Cole',
  ...
  },
  {
    ...
    story: [
      ...
      'The $275,000 grant covered the remaining terms. I attend during the day. My son sees me in scrubs and thinks that is what grown-ups wear to become useful. I like that story better than the one where I quit.',
    ],
  },
  {
    name: 'Linda K.',
    ...
    story: [
      ...
      'The $810,000 grant held the closing. We moved in October. The first snow I stood in the doorway with a mug and did not have to ask a landlord if the heat would be on. That is the whole story. Thank you is not large enough, but it is honest.',
    ],
  },
  {
    name: 'Omar T.',
  ...
  },
  {
    ...
    story: [
      ...
      'The $345,000 grant covered the heater, the copays, and the remaining school costs. I can breathe in my own kitchen again. If you are looking for financial assistance and your life is more than one checkbox, you are still allowed to apply.',
    ],
  },
  {
    name: 'Frank Delaney',
  ...
  },
  {
    ...
    story: [
      ...
      'The $240,000 grant closed those two files. I still live in my house. I still make soup on Sundays. If you are a senior reading this and you think asking is shameful, I asked. They answered. You can too.',
    ],
  },
  {
    name: 'Samuel Okoye',
    ...
    story: [
      ...
      'The $880,000 grant closed the oncology balance. I still have scans. I do not have a collector. If you are looking at medical bills and wondering whether a grant is real, IDA grants are not loans. That sentence is why I applied.',
    ],
  },
  {
    name: 'Patricia M.',
    ...
    story: [
      ...
      'The $165,000 grant repaired the roof. I still volunteer. I do it dry. That is a small miracle and I will say thank you every time someone asks how the house looks.',
    ],
  },
];
